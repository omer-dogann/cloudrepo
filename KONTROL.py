...
try:
    ...
    class CloudScraper:
        ...
        def post(self, url, **kwargs):
            raise NotImplementedError("cloudscraper is required for RecTV post requests")
...
class MainUrlUpdater:
    ...
    def guncelle(self):
        for dosya, mainurl in self.mainurl_listesi.items():
            eklenti_adi = re.split(r'[/\\]', dosya)[0]
            ...
            if self._versiyonu_artir(os.path.join(eklenti_adi, "build.gradle.kts")):
